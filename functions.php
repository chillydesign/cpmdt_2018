...
function remove_id_column($headings, $form_id) {
	...
	if ($form_id == 5) {
		...
		$headings = (array_slice($headings, 0, $position1, true) +
			array('lieu' => 'Lieu') +
	...
	if ($form_id == 17) {
		...
		$headings = (array_slice($headings, 0, $position11, true) +
			array('lieu' => 'Lieu') +
...
function theme_js() {
	...
	wp_enqueue_script('app', get_template_directory_uri() . '/js/app.js', array('jquery'), wf_version(), true);
	wp_enqueue_script('scripts', get_template_directory_uri() . '/js/scripts.js', array('jquery'), wf_version(), true);
}
